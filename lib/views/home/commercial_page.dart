...
class _CommercialPageState extends State<CommercialPage> {
  ...
  void _loadDeliveries() {
    ...
    // Carrega entregas relacionadas ao comerciante
    _deliveryService.getCommercialDeliveries().listen(
      (deliveries) {
  ...
  void _verDetalhes(Delivery entrega) {
    // Comerciante apenas visualiza detalhes, não pode enviar fotos
    Get.toNamed(
      '/delivery_details',
      arguments: {'entrega': entrega, 'readOnly': true},
    );
  }
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          if (entrega.entregador.isNotEmpty)
                            Text('Entregador: ${entrega.entregador}'),
                        ],
                      ),
